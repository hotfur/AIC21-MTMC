...
def get_args():
    ...
    parser.add_argument("data", nargs=1, help="Path to <predicted_labels>.")
...
def usageMsg():
    return """  python3 eval.py <prediction> --dstype <dstype>
...
if __name__ == '__main__':
    ...
    test = readData('ground_truth_test.txt') #readData(args.data[0])
    pred = readData(args.data[0])
    try:
